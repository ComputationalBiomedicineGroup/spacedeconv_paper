...
Wu Slides
show density of most abundant cancer type (RCTD)

```{r}
library(spacedeconv)
library(SpatialExperiment)

#load all deconvolution results for the Wu et al slides for RCTD (in_tissue)
#basal
allresults_minor_1142243F <- readRDS("/gpfs/gpfs1/scratch/c1041165/spacedeconv-paper-mz/deconv_allmeth_onespe_intissue/allresults_minor_1142243F.rds")

allresults_minor_1160920F <- readRDS("/gpfs/gpfs1/scratch/c1041165/spacedeconv-paper-mz/deconv_allmeth_onespe_intissue/allresults_minor_1160920F.rds")

allresults_minor_4465 <- readRDS("/gpfs/gpfs1/scratch/c1041165/spacedeconv-paper-mz/deconv_allmeth_onespe_intissue/allresults_minor_4465.rds")

allresults_minor_44971 <- readRDS("/gpfs/gpfs1/scratch/c1041165/spacedeconv-paper-mz/deconv_allmeth_onespe_intissue/allresults_minor_44971.rds")

#lumA
allresults_minor_4290 <- readRDS("/gpfs/gpfs1/scratch/c1041165/spacedeconv-paper-mz/deconv_allmeth_onespe_intissue/allresults_minor_4290.rds")

#lumB
allresults_minor_4535 <- readRDS("/gpfs/gpfs1/scratch/c1041165/spacedeconv-paper-mz/deconv_allmeth_onespe_intissue/allresults_minor_4535.rds")


```

Most abundant cancer cell types for each patient according to RCTD results
1142243F: basal
1160920F: basal
4465: basal
44971: basal
...
Grid 6x4, on the left the sample names the column names should be the 4 cancer molecular subtypes
Scales min=0, max=1
...
ggsave("/gpfs/gpfs1/scratch/c1041165/spacedeconv-paper-mz/plots_paper/suppl1/suppl1_300dpi_extra.png", plot = grid_1, dpi = 300)

#Save the UMAP as a high-resolution PDF with specified dimensions
ggsave("/gpfs/gpfs1/scratch/c1041165/spacedeconv-paper-mz/plots_paper/suppl1/suppl1_300dpi_extra.pdf", plot = grid_1, dpi = 300)
