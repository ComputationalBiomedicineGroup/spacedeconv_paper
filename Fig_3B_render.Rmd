...
<!-- ```{r comparison, collapse=TRUE, eval=FALSE} -->
...
<!--   colData(spe)[spot, "IEUnknown"] <- sumUnknownIE -->
<!--   colData(spe)[spot, "IEOther"] <- sumOther -->

<!--   # IE Antigen -->
<!--   unknownAnti <- tmp[tmp$IEDB_antigen=="Unknown", ] -->
<!--   otherAnti <- tmp[tmp$IEDB_antigen!="Unknown", ] -->
<!--   sumUnknownAnti <- sum(unknownAnti$UMIs) -->
<!--   sumOtherAnti <- sum(otherAnti$UMIs) -->
<!--   colData(spe)[spot, "AntiUnknown"] <- sumUnknownAnti -->
<!--   colData(spe)[spot, "AntiOther"] <- sumOtherAnti -->
...
<!--   colData(spe)[spot, "VDJUnknown"] <- sumUnknownVDJ -->
<!--   colData(spe)[spot, "VDJOther"] <- sumOtherVDJ -->
...
<!-- #plot_comparison(spe, cell_type_1 = "AntiUnknown", cell_type_2 = "AntiOther", density = F, smooth = T, title = "IEDM_Antigen") -->
<!-- vdj <- plot_comparison(spe, cell_type_1 = "VDJUnknown", cell_type_2 = "VDJOther", density = F, smooth = T, title = "VDJUnknown/VDJOther", palette = "Vik", title_size = title_size, spot_size = 1.03) -->
<!-- ``` -->
